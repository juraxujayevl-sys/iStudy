...
export const translations: Record<Language, Translations> = {
  uz: {
    ...
    about: {
      ...
      bioParagraph1: 'Men O\'zbekistonda joylashgan AI Muhandis va Kontent Meykerman. Mening asosiy yo\'nalishim — muxtor (autonomous) AI agentlarini yaratish, LLaMA va boshqa LLM modellarini mahalliy tillar uchun fine-tune qilish hamda zamonaviy dasturlash vositalarini amalda qo\'llashdir.',
      bioParagraph2: 'Media va muhandislik uyg\'unligi orqali men texnologiyalarni nafaqat kod ko\'rinishida yozaman, balki ularni millionlab insonlarga tushunarli vizual formatda yetkazib beraman.',
  ...
  ru: {
    ...
    about: {
      ...
      bioParagraph1: 'Я AI-инженер и автор контента из Узбекистана. Моя специализация — разработка автономных AI-агентов, точная настройка (fine-tuning) LLM моделей и внедрение передовых нейросетевых решений.',
      bioParagraph2: 'Синергия разработки и медиа позволяет мне не только писать чистый код, но и эффективно доносить ценность продуктов до миллионов разработчиков.',
  ...
  en: {
    ...
    about: {
      ...
      bioParagraph1: 'I am an AI Engineer and Content Creator based in Uzbekistan. I specialize in building autonomous AI agents, fine-tuning open-source LLMs like LLaMA-3, and deploying real-world intelligent systems.',
      bioParagraph2: 'Through engineering and media synergy, I craft clean scalable code and deliver visual storytelling that engages millions of tech enthusiasts worldwide.',
